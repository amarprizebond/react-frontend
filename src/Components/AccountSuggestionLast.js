...
function AccountSuggestionLast(props) {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        setClosed(true);
        SetUserStat({ searchCount: userstat.searchCount, accuontSuggestionDismissFlagLast: true });
    }

    if ( userstat.searchCount < 10 || userstat.accuontSuggestionDismissFlagLast ) {
        return (<></>);
    }
...
export default AccountSuggestionLast;